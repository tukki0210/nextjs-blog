---
title: 'Laravel8とvue.js3をAPIによって連携させる'
date: '2021-12-15'
...
とりあえずAPIの発信を行うために、index()アクションだけを設定し、テーブルの本のリストを全て表示します。
...
<bold>api/book</bold>にアクセスして、APIが取得できるか確認してください。
